          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white/40 dark:bg-slate-900/40 transition-colors">
            ...
            <div className="mb-10">
              <h2 className="text-4xl font-black text-slate-800 dark:text-white leading-tight">
                Ready to <span className="text-indigo-600 dark:text-indigo-400">Level Up</span> Your Skills?
              </h2>
              <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">Join thousands of students mastering tech daily.</p>
            </div>
